...
</script><body>       <div class="preloader"><div class="preloader__row"><div class="preloader__item"></div><div class="preloader__item"></div><div class="preloader__item"></div><div class="preloader__item"></div></div></div><div class="wrapper nav_wrapper nav_wrapper_mobile"><div class="nav"><img class="logo" src="assets/img/2nav/veronica.svg"><div class="burger"><span class="burger__line line1"></span><span class="burger__line line2"></span><span class="burger__line line3"></span></div><div class="mobile-menu"></div></div></div><script src="assets/js/basic_components/jquery/jquery.min.js"></script><script src="https://unpkg.com/imask@6.4.2/dist/imask.js"></script><script src="assets/js/basic_components/slickslider/slick.min.js"></script><script src="assets/js/map.js" type="module"></script><script src="assets/js/secondScripts.js" type="module"></script><script async>function appendToHead(a,c){
    if("css"==a)
...
appendToHead('css', 'assets/css/secondStyles.min.css');</script><script></script></body></html>